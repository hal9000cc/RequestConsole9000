...
Процедура ВыполнитьТестовыйЗапрос()
...
Процедура ТаблицаВРеквизитыФормы(ТаблицаЗначений, ТаблицаЗначенийРеквизит, ТаблицаЗначенийКолонкиКонтейнераРеквизит) Экспорт
...
Функция Контейнер_Очистить(Контейнер) Экспорт
	...
	Возврат Контейнер_СохранитьЗначение(Значение);
