...
Процедура ВыполнитьЗапрос(фИспользоватьВыделение)
	...
	Иначе
		...
		ВремяВыполнения = Формат('00010101' + Цел((ВремяОкончания - ВремяНачала)/1000), "ДЛФ=T; ДП=0:00:00")+"."+Формат(ВремяОкончания - ВремяНачала - Цел((ВремяОкончания - ВремяНачала)/1000)*1000, "ЧЦ=3; ЧВН=");
